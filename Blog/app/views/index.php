...
<div class="container">
  <form method="POST" action="/Blog/" class="row gy-2 gx-3 align-items-center justify-content-center mb-5">
    <div class="col-12 col-md-4">
      <input class="form-control form-control-lg" name="pesquisa" type="search" placeholder="Pesquisar post..." aria-label="Pesquisa">
    </div>
    <div class="col-auto">
      <button class="btn btn-success btn-lg" type="submit"><i class="bi bi-search"></i> Pesquisar</button>
    </div>
    <div class="col-auto">
