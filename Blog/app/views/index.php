...
<div class="container-fluid ml-5 mr-8">
    ...
    <input class="form-control me-2 col-2" name="pesquisa" type="search" placeholder="post" aria-label="Pesquisa">
      <button class="btn btn-outline-success ml-2" type="submit">Pesquisar</button>
      <input class="btn btn-primary btn-lg ml-2" name="recente" type="submit" value="Mais Recente">
      <button type="submit" name="doAntigo" class="btn btn-outline-primary btn-sm ml-2">
        <i class="bi bi-arrow-up"></i>Antigos
      </button>
      <button type="submit" name="doRecente" class="btn btn-outline-primary btn-sm ml-2">
        <i class="bi bi-arrow-down"></i>Recentes
      </button>
      <a class="btn btn-outline-primary btn-sm d-flex align-items-center justify-content-center ml-2" href="/Blog/novoPost/">Novo Post</a>
</form>
